package com.microservice.notification.service.configuration;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, Notification> consumerFactory() {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.microservice.commons.kafka.Notification");
